# memory-storage-foundation Specification

## Purpose
Define the foundational PostgreSQL storage contract for raw events, canonical memories, version history, provenance, and future retrieval extensions.
## Requirements
