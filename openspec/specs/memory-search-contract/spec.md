# memory-search-contract Specification

## Purpose
Define the public memory search API contract for scoped hybrid retrieval, ranking, and citation-bearing result delivery.
## Requirements
